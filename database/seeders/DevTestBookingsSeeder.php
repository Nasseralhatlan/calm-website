        ...
        foreach ($places as $place) {
            foreach ($rows as [$set, $state, $start, $end, $status, $confirmedAt, $expiresAt]) {
                ...
                Booking::query()->create([
                    ...
                    'booking_price' => (int) $place->price * 100,   // base nightly snapshot
                    'quantity' => $nights,
                    'host_gross_amount' => $subtotalMinor,
                    'commission_rate' => self::COMMISSION_RATE,
                    'commission_amount_ex_vat' => $commissionMinor,
                    'guest_vat_rate' => self::VAT_RATE,
                    'guest_vat_amount' => $vatMinor,
                    'guest_total' => $subtotalMinor + $vatMinor,
