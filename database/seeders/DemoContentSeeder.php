...
class DemoContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $reviewPool = [
            ...
            ['محمد', 4, 'تجربة جميلة، الموقع سهل الوصول والمرافق ممتازة.'],
            ['نورة', 5, 'من أجمل الأماكن التي جربناها، بالتأكيد سنكرر الزيارة.'],
            ['عبدالله', 5, 'المكان مطابق للصور تماماً والخصوصية عالية.'],
            ['ريم', 4, 'قضينا وقتاً رائعاً، المسبح نظيف والجلسات مريحة.'],
        ];
