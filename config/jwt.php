...
return [
    ...
    */
    ...
    'cookie_key_name' => env('JWT_COOKIE_NAME', 'calm_token'),

    /*
    |--------------------------------------------------------------------------
    | Cookie attributes (used when the controller sets the JWT cookie)
    |--------------------------------------------------------------------------
    */

    'cookie_secure' => env('JWT_COOKIE_SECURE', false),
    'cookie_same_site' => env('JWT_COOKIE_SAMESITE', 'lax'),
